...
# Note from Terry (16/9/09):
# This (MIT License) code comes from http://code.google.com/p/mimeparse/
...
def parse_mime_type(mime_type):
    ...
    # a single "*". Turn it into a legal wildcard.
    if full_type == '*':
        full_type = '*/*'
        ...
        if ((type == target_type or type == '*' or target_type == '*')
            ...
            param_matches = reduce(
                ...
                [1 for (key, value) in target_params.iteritems()
                 if key != 'q' and key in params and value == params[key]], 0)
